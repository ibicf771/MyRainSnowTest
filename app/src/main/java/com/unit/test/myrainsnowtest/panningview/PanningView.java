package com.unit.test.myrainsnowtest.panningview;
...
import com.unit.test.myrainsnowtest.R;
...
public class PanningView extends View {
    ...
    private Panning PANNING = new HorizontalPanning(HorizontalPanning.RIGHT_TO_LEFT);
